  ...
  console.log("searchValue : ", searchValue)
    const columns: TableProps<Guichet>["columns"] = [
      ...
      doc.setFontSize(16);
        ...
        doc.text("List de Guichet - Agence Nouakchott", 10, 25);
        if (dates[0] && dates[1]) {
      ...
      const exportToExcel = async () => {
        ...
        XLSX.writeFile(workbook, "Guichet-nktt.xlsx");
      ...
      const exportToCSV = async () => {
        ...
        link.setAttribute("download", "Guichet-nktt.csv");
